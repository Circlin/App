...
import CircleIndicator from '../../components/indicator/CircleIndicator/CircleIndicator';
...
class AddProfile04Screen extends Component {
  constructor(props) {
    super(props);
  }
  state = {
    ...
    await fetch(API_URL + 'birth', {
      ...
      .then((result) => {
        ...
        if (result.resPonseCode == 200) {
          this.props.navigation.navigate('AddProfile05', {
            uid: uid,
          });
        }
      })
...
export default AddProfile04Screen;
